...
int mov_crankshaft() {
  ...
  double starting_point[3] = {
    (double) poly_lattice_coordinates[3 * poly_index_p1],
    (double) poly_lattice_coordinates[3 * poly_index_p1 + 1],
    (double) poly_lattice_coordinates[3 * poly_index_p1 + 2]
  };
  double end_point[3] = {
    (double) poly_lattice_coordinates[3 * poly_index_p2],
    (double) poly_lattice_coordinates[3 * poly_index_p2 + 1],
    (double) poly_lattice_coordinates[3 * poly_index_p2 + 2]
  };
  //
  //    stdoutlog = fopen(stdoutlogname, "a");
  ...
  for (int i = 0; i < gap; i++) {
    int initial_point[3] = {
      poly_lattice_coordinates[3 * (poly_index_p1 + 1 + i)],
      poly_lattice_coordinates[3 * (poly_index_p1 + 1 + i) + 1],
      poly_lattice_coordinates[3 * (poly_index_p1 + 1 + i) + 2]
    };
...
int mov_pivot() {
  ...
  for (int i = 0; i < gap; i++) {
    int initial_point[3] = {
      poly_lattice_coordinates[3 * (poly_index_p2 + 1 + i)],
      poly_lattice_coordinates[3 * (poly_index_p2 + 1 + i) + 1],
      poly_lattice_coordinates[3 * (poly_index_p2 + 1 + i) + 2]
    };
...
int mov_planar_reflection() {
  ...
  double starting_point[3] = {
    (double) ph_poly_lattice_coordinates[3 * poly_index_p1],
    (double) ph_poly_lattice_coordinates[3 * poly_index_p1 + 1],
    (double) ph_poly_lattice_coordinates[3 * poly_index_p1 + 2]
  };
  double end_point[3] = {
    (double) ph_poly_lattice_coordinates[3 * poly_index_p2],
    (double) ph_poly_lattice_coordinates[3 * poly_index_p2 + 1],
    (double) ph_poly_lattice_coordinates[3 * poly_index_p2 + 2]
  };
...
int mov_translation() {
  ...
  int int_translated_vector[3] = {
    poly_lattice_coordinates[3 * poly_index_p1],
    poly_lattice_coordinates[3 * poly_index_p1 + 1],
    poly_lattice_coordinates[3 * poly_index_p1 + 2]
  };
